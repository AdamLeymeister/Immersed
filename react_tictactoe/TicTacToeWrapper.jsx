...
import { securityEventOne, securityEventFour } from "./components/layout/SecurityEvents";
...
HandleSecurityEvent(securityEventOne,['Control','Shift','E'], playerInfo.longId, currentUser)
HandleSecurityEvent(securityEventFour,['Control','Shift','E'], playerInfo.longId, currentUser)
